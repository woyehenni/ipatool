...
export class StoreRequest {
  ...
  public static async authenticate(
    ...
    if ((<StoreFailureResponse>parsedResp).hasOwnProperty("failureType")) {
      if (
        (<StoreFailureResponse>parsedResp).customerMessage ===
  ...
  public static async download(
    ...
    const resp = await this.fetch(StoreEndpoint.download(this.guid), {
      method: "POST",
      body: body,
  ...
  public static async purchase(
    ...
    const resp = await this.fetch(StoreEndpoint.purchase, {
      method: "POST",
      body: body,
      headers: Object.assign(this.commonHeaders, {
        "X-Dsid": directoryServicesIdentifier,
